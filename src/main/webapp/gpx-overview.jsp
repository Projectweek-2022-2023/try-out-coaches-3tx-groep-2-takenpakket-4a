...
<jsp:include page="header.jsp">
    <jsp:param name="actual" value="GPX"/>
</jsp:include>
<div id="container">
    <main>
<c:choose>
    ...
    <c:otherwise>
        ...
        value="${latPreviousValue}" required>
        </p>

        <p class="form-group ${lonClass}">
        <label class="control-label" for="lon">Lon:</label>
        <input id="lon" name="lon" type="number"
        value="${lonPreviousValue}" required>
        </p>
        ...
        <div id="map"></div>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBy0THRrjpJ9qPhGrTC6UG2cdRVAvKz6lU&callback=initMap" defer></script>
    </main>
</div>
